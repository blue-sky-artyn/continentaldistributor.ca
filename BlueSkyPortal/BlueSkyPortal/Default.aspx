...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceFooterBody" Runat="Server">
    ...
    <section class="accordion video-section js-height-full">
        <ul id="sliderHtml" runat="server" clientidmode="Static" >
            <li>
                <div>
                    <a href="#" class="sliderLink">
                        <h2>The crown molding</h2>
                        <p>
                            Easy to install<br>
                            Stylish<br>
                            Washable<br>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="custom-module p40l">
                        <h2 id="coTitleHtml" runat="server">Benefits of using <mark>Decowall inc</mark> moulding<br>
                            over other availablemoulding in the market</h2>

                        <p id="coDetHtml" runat="server">Nam dictum sem, ipsum aliquam . Etiam sit amet fringilla lacus. Pellentesque suscipit ante at ullamcorper pulvinar neque porttitor. Integer lectus. Praesent sed nisi eleifend, fermentum orci amet, iaculis libero.</p>
