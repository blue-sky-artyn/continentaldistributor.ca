...
public partial class footer : System.Web.UI.MasterPage
{
    ...
    {
        tblProuctTagesCollection productTagsTbl = new tblProuctTagesCollection();
        productTagsTbl.ReadList();

        for (int i = 0; i < productTagsTbl.Count; i++)
        {
            tagesHtml.InnerText += "<li><a href='#'>moulding</a></li>";
        }
    }
